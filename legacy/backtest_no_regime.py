...
def main():
    ...
    params = {
        ...
        'liquidate_on_bear_market': False, # SWITCHED OFF
        'allocate_in_gold': False          # SWITCHED OFF
    }
    ...
    print("Running Backtest (Pure Momentum - No Regime Filter)...")
    for date, momentum_row in weekly_momentum.iterrows():
        ...
        is_bull_market = True # ALWAYS TRUE (NO REGIME)
    ...
    print("\n" + "="*60)
    print("BACKTEST RESULT: AGGRESSIVE (NO REGIME FILTER)")
    print("="*60)
