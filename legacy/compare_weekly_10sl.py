...
def main():
    ...
    # Common edits: Weekly rebalance and 10% SL
    ...
    configs = [("Balanced (Weekly, 10% SL)", balanced_params), ("Aggressive (Weekly, 10% SL)", aggressive_params)]
    results = []
    ...
    print("\n" + "="*60)
    print("WEEKLY REBALANCE COMPARISON (10 YEARS) - 10% STOP LOSS")
    print("="*60)
